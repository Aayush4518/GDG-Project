    ...
    const start = async () => {
      ...
      timer = setInterval(async () => {
        try {
          ...
          setCoords({ latitude: body.latitude, longitude: body.longitude });
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <View style={{ width: 40 }} />
        <Text style={styles.headerTitle}>Travel Guardian</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.mapContainer}>
                ...
                {results.map((r) => (
                  <TouchableOpacity key={r.id} style={styles.resultRow} onPress={() => handleLocationPress(r)}>
                    ...
                    <View style={{ marginLeft: 8, flex: 1 }}>
                      ...
                      <Text style={styles.resultSub}>{riskLabelMap[r.risk]}</Text>
                    </View>
                  </TouchableOpacity>
                ))}
              </ScrollView>
        ...
        <View style={styles.notifierContainer}>
          ...
          <View style={styles.safetyCard}>
            ...
            <Text style={[styles.safetyTextLabel, { color: areaSafety === 'high' ? '#e74c3c' : areaSafety === 'medium' ? '#f39c12' : '#27ae60' }]}>Area Safety: {riskLabelMap[areaSafety]}</Text>
          </View>
        </View>
      ...
      {/* Emergency Button (bottom-center, large) */}
