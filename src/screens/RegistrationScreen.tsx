  ...
  const handleRegister = async () => {
    ...
    try {
      const res = await api.register({
        ...
        kyc_hash: 'placeholder_kyc_hash',
        emergency_contact: { name: formData.emergencyContactName, phone: `${selectedCountryCode.code} ${formData.emergencyContactPhone}` },
        trip_start_date: new Date(formData.tripStartDate).toISOString(),
        trip_end_date: new Date(formData.tripEndDate).toISOString(),
      });
      await storage.setTouristId(res.tourist_id);
